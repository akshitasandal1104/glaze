...
export class PolicyKnowledgebaseComponent implements AfterViewInit, OnInit,OnDestroy {
  pageTitle = 'Policies';
  ...
  constructor(private assetGroupObservableService: AssetGroupObservableService,
    ...
    this.currentPageLevel = this.routerUtilityService.getpageLevel(this.router.routerState.snapshot.root) ? this.routerUtilityService.getpageLevel(this.router.routerState.snapshot.root) : 0 ;
