...
export const CONFIGURATIONS = {
    required: {
        ...
        domains: {
            ...
            DEV_BASE_URL: 'http://gui4-glaze.bakestack.com/api', // Expected values: domain where the API is deployed, ex: http://devbeta.pacbot.com/api
            CLOUD_BASE_URL: 'http://gui4-glaze.bakestack.com', // Expected values: domain where the API is deployed
        },
        featureModules: {
